...
public class IntentShim extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("startActivity") || action.equals("startActivityForResult")) {
            ...
            Log.d("externalData", obj.getJSONObject("extras").toString());
            intent.putExtra("externalData", obj.getJSONObject("extras").toString());
            ...
            JSONObject obj = args.getJSONObject(0);
            JSONObject extra = obj.getJSONObject("extras");
            JSONObject component = obj.getJSONObject("component");
            String authToken = extra.getString("auth_token");
            String packageName = component.getString("package");
            String className = component.getString("class");
    ...
    private String getRealPathFromURI_API19(JSONObject obj, CallbackContext callbackContext) throws JSONException {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            ...
            if (uri.getHost().contains("com.android.providers.media")) {
                ...
                Cursor cursor = this.cordova.getActivity().getApplicationContext().getContentResolver()
